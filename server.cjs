...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Asset Tracker Central";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Asset Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "asset_record_records";
'use strict';
